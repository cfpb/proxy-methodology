...
use "`maindir'/`inst_name'_proxied_blkgrp18_jan20.dta"

* Merge in BISG proxies based on tract.
merge 1:1 `matchvars' using "`maindir'/`inst_name'_proxied_tract18_jan20.dta"
assert _m == 3
drop _m

* Merge in BISG proxies based on ZIP code.
merge 1:1 `matchvars' using "`maindir'/`inst_name'_proxied_zip18_jan20.dta"
assert _m == 3
drop _m
...
save  "`maindir'/`inst_name'_proxied_final_jan20.dta",replace   
